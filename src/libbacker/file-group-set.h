...
public:
    ...
    std::map<std::string, std::vector<std::shared_ptr<backer::FileSystemEntry>>> listAndGroupDuplicates(const std::vector<std::shared_ptr<backer::FileSystemEntry>>& flattenedList);
};
